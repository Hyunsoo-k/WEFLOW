import type { CaseItem } from '@/features/cases/types/caseItem';
import { CASES_PAGE } from '@/features/cases/data/casesText';
import { OverflowCarousel } from '@/shared/carousels/OverflowCarousel/OverflowCarousel';
