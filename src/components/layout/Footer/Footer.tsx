      ...
      <div className={styles.inner}>
        ...
        <div className={styles.businessInfo}>
          ...
          <ul className={styles.infoList}>
            ...
            <li className={styles.item}>
              <span className={styles.text}>사업자등록번호 : 884-07-03480</span>
            </li>
            <li className={styles.item}>
              <span className={styles.text}>이메일 : contact@weflowlab.kr</span>
            </li>
            <li className={styles.item}>
              <span className={styles.text}>운영시간  : 연중무휴 24시간 상담가능</span>
            </li>
          </ul>
        </div>
        <div className={styles.lawInfo}>
          ...
          <ul className={styles.infoList}>
            <li className={styles.item}>
              <Link href='/' className={styles.lawLink}>개인정보 처리방침</Link>
            </li>
            <li className={styles.item}>
              <Link href='/' className={styles.lawLink}>이용약관</Link>
            </li>
          </ul>
        </div>
      </div>
